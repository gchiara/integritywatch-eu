...
csv('./data/organizations.csv?' + randomPar, (err, organizations) => {
  ...
  _.each(organizations, function (d) {
    ...
    if(!$.isNumeric(d.costVal)){
      ...
      d.expenseVal = '10K-50K';
    } else if(d.costVal <= 100000){
      d.expenseVal = '50K-100K';
    } else if(d.costVal <= 200000){
      d.expenseVal = '100K-200K';
    } else if(d.costVal <= 500000){
      d.expenseVal = '200K-500K';
  ...
  var createExpenseChart = function() {
    ...
    chart
      ...
      .x(d3.scaleBand().domain(["0", "< 10K", "10K-50K", "50K-100K", "100K-200K", "200K-500K", "500K-1M", "1M-2M", "2M-5M", "> 5M"]))
