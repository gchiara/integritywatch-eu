      ...
      <div class="container">
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse in">
              <div class="panel-body">
                ...
                <p>The website currently contains three different datasets on the following topics:</p>
                <ul>
                  <li>Data on the members of the European Parliament (MEPs), mainly on their outside activities and incomes</li>
                  <li>Data on lobbying in Brussels. For that we have combined the records of lobby meetings at the European Commission with the information contained in the EU Transparency Register – the register of Brussels lobbyists</li>
                </ul>
                <p>Information from the declaration of financial interest of MEPs provides a unique overview of their activities and enables a range of rankings and visual comparisons. It also allows to identify those MEPs with a high degree of external activity and to better monitor them for potential conflicts of interests between their legislative work in the Parliament and their outside activities.</p>
                <p>Self-reported data of senior public officials of the European Commission on lobby meetings contains a range of potential important insights on current dynamics and content of lobby activities. Data from the voluntary Transparency Register provides additional information on who those lobbyists are, how much they spent on lobbying, how many people they have working for them and what files and topics they are active on.</p>
          ...
          <div class="panel panel-default">
            ...
            <div id="collapse3" class="panel-collapse collapse">
              <div class="panel-body">
                ...
                <p>All data used for the tools on “MEP incomes”, “Commission meetings” and “EU Lobbyist” available on EU Integrity Watch comes from the websites of the EU Institutions. EU Integrity Watch reuses the data published by <a href="http://parltrack.euwiki.org/" target="_blank">Parltrack</a> which extracts the information from the original websites. We have used the following datasets:
                <p>For the tool on “MEP incomes”:</p>
                <ul>
                  <li>General information contained on the sites of the 751 MEPs, such as this <a href="http://www.europarl.europa.eu/meps/en/1911/martin_schulz_home.html">page</a> for President Martin Schulz on nationality, party and group memberships, committee memberships…</li>
                  <li>The declarations of financial interests that all MEPs have to fill out. These declarations are also available on the same page. The example for President Martin Schulz can be found <a href="http://www.europarl.europa.eu/mepdif/1911_dfi_rev0_de.pdf">here</a>.</li>
                </ul>
                <p>For the tools on “Commission meetings” and “EU Lobbyists”:</p>
                <ul>
                  <li>The lists of meetings with lobbyists published on the websites of European Commissioners and Directors-General. An example for European Commission President Jean-Claude Juncker can be found <a href="http://ec.europa.eu/transparencyinitiative/meetings/meeting.do?host=829436d0-1850-424f-aebe-6dd76c793be2">here</a>. The complete information is scattered over 98 different webpages as each Commissioner, each Cabinet and each DG have their own page. However, the individual entries of each lobby organisation on the Transparency Register contains the most up to date lists of meetings published by Commission officials. To access the full dataset of Commission meetings in open data format, please contact <a href="mailto:rkergueno@transparency.org">rkergueno@transparency.org</a>.</li>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">4. Additional information on the Commission meeting and Brussels lobbying tools</a>
              </h2>
            </div>
            <div id="collapse4" class="panel-collapse collapse">
              <div class="panel-body">
                ...
                <p>Created in 2011 as a joint register for lobbyists by the European Commission and Parliament, the voluntary register of Brussels lobbyists has undergone multiple revisions. Following the launch of an updated website on 27 January 2015, all registered organisations had to undergo a first annual update of their information. Despite the suspension of several hundred organisation and updated declarations from more than 7800 organisations that are currently registered, the quality of the data remains relatively poor, although improving compared to previous years. Transparency International has been campaigning for a mandatory register with meaningful sanctions for lobbyists that break the rules.</p>
                <h3>What does Transparency International recommend to improve lobbying transparency?</h3>
                <p>The European Commission under Jean-Claude Juncker has taken good steps in the right direction when it comes to lobbying transparency. Allowing only registered lobbyists to meet the highest level of decision-makers and publishing those meetings have greatly improved transparency and are indeed the reason this present analysis was possible at all.
                Nevertheless, the findings of our work also illustrate that more is needed to ensure transparency, integrity and equality of access in EU lobbying. We recommend to:</p>
                <ol>
                  <li><strong>Make the EU Transparency Register mandatory</strong><br /><span>Only if registration is mandatory for lobbyists can we be sure to capture all those seeking to directly or indirectly influence EU decision-making. A mandatory register would also allow sanctioning of organisations that do not comply with the rules. The Transparency Register Secretariat needs to be provided with the necessary resources to better check the declarations for possible errors, particularly on those organisations that have frequent meetings at the highest level. Smart online tools like Integrity Watch can help in that regard. The European parliament and the European Council should follow the Commission’s lead in only meeting with registered lobbyists and publishing their meetings.Such an order to all officials would not create any additional costs and could be put in place immediately. All it would take is a decision by the political leadership to say that unregistered lobbyists are no longer welcome and make EU decision-making more transparent and accountable. In January 2019, the European parliament has taken a small step in the right direction by voting in favour of the publication of meetings of key MEPs (Rapporteurs, shadow rapporteurs and Committee Chairs). This information will be made available on Integrity Watch in a future update.</span></li>
                  <li><strong>Introduce a Legislative Footprint for EU decision-making and legislation</strong><br /><span>A legislative footprint is a comprehensive public record of lobbyists’ influence on a piece of legislation or public decision. This can be established through the registration of meetings and by capturing written input from lobbyists. The Commission has started both, but the measures need to be extended to everyone involved in the decision-making process. This means extending current provision to the lower levels of the Commission but more importantly to the European Parliament and Council. Standardisation of subject matters and the mentioning of concrete legislative files as well as the use of open data would greatly increase the usability of the data by a wider audience. Our detailed recommendations to all three European Institutions can be found in this <a href="http://www.transparencyinternational.eu/wp-content/uploads/2015/03/transparency-05-small-text-web.pdf">paper</a>.</span></li>
                </ol>
              </div>
            </div>
          </div>
