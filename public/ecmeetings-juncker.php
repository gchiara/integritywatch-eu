...
<head>
    ...
    <link rel="stylesheet" href="static/meetingsjuncker.css">
</head>
<body>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12 chart-col commission-select-container">
                <a href="./ecmeetings-juncker.php" class="link-button" :class="{active: oldcommission == true}">Juncker Commission (2014-2019)</a>
                <a href="./ecmeetings.php" class="link-button" :class="{active: oldcommission == false}">Von der Leyen Commission (2019 - 2024)</a>
              </div>
            </div>
          </div>
            ...
            <div class="modal-body">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    Dear visitor,<br />
                    For any questions, please feel free to get in touch:<br /><br />
                    Raphaël Kergueno<br />
    ...
    <script src="static/meetingsjuncker.js"></script>
